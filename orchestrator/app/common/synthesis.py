...
async def synthesize(ctx, *, upstream_ids: list[str], system_prompt: str,
    ...
    user += (
        ...
        "9. Write about the SUBJECT. Neither the requester nor this system's own "
        "run history is content: recalled or historical material orients you, and "
        "is never a finding or a rationale.\n"
    )
