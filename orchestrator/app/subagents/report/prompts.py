...
SYSTEM_PROMPT = (
    ...
    "Keep each section to what a reviewer will actually read: a few tight "
    "paragraphs. Length is not thoroughness, and nothing here should be longer than "
    "the asset it draws on.\n\n"
